...
import { Calendar, CheckCircle2, Circle, Clock, MapPin, Flag, Play, ChevronDown, ChevronUp, Lock } from 'lucide-react';
...
const StudyPathTimeline: React.FC<{ plan: StudyPlan }> = ({ plan }) => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-indigo-100 overflow-hidden mb-10 animate-in slide-in-from-top-4 duration-700">
      {/* Header do Plano */}
      <div className="bg-slate-900 p-6 md:p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/10 min-w-[150px]">
                    ...
                    <div className="px-5 pb-5 pt-2 border-t border-slate-100/50 animate-in slide-in-from-top-2">
                       ...
                       {status === 'active' && (
                         <div className="mt-4 pt-4 border-t border-slate-100">
                           <button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-indigo-200">
